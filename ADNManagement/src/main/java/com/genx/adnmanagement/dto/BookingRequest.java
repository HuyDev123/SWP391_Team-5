...
public class BookingRequest {
    ...
    private Integer userId; // Thay customerId bằng userId
    private Integer numParticipants;
    private List<Integer> sampleCounts;
    // getters and setters
    ...
    public List<Integer> getSampleCounts() { return sampleCounts; }
    public void setSampleCounts(List<Integer> sampleCounts) { this.sampleCounts = sampleCounts; }
}
