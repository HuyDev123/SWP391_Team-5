...
public class PageController {
    ...
    public String services(Model model, HttpSession session) {
        ...
        for (Service service : services) {
            ...
            map.put("extraPerSampleFee", service.getExtraPerSampleFee());
    ...
    public String paymentHistory(Model model, HttpSession session, HttpServletRequest request) {
        return requireLogin(model, session, "payment-history", request);
    }
    ...
    public String paymentManagement(Model model, HttpSession session, HttpServletRequest request) {
        return requireStaffLogin(model, session, "payment-management", request);
    }
