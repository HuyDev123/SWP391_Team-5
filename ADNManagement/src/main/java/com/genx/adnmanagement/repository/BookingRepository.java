...
public interface BookingRepository extends JpaRepository<Booking, Integer> {
    ...
    // Method for staff payment management - get bookings without full payment
    @Query("SELECT DISTINCT b FROM Booking b WHERE b.paymentMethod IS NOT NULL ORDER BY b.bookingDate DESC")
    List<Booking> findBookingsWithoutFullPayment();
}
